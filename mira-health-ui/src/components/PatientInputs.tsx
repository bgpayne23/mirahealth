...
const PatientInputs = () => {
 ...
 const onSubmit = (data: FormValues) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg mt-9"> 
  ...
  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white shadow-lg focus:ring-2 focus:ring-blue-600`} 
  id="grid-first-name" 
  type="number" 
  placeholder=""/>
{errors.Age && <p className="text-red-500 text-xs italic">{errors.Age.message}</p>}
    ...
    <option value="Hispanic, Latino, or Spanish Origin">Hispanic, Latino, or Spanish Origin (of any race)</option>
    </select>
    </div>
  </div>
  <div className="flex flex-wrap -mx-3 mb-6">
