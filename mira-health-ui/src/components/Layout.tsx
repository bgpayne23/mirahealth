        ...
        <div className='flex justify-center min-h-screen bg-white'>
            <div className="w-full min-h-screen bg-white flex flex-col">
                <div className="flex justify-center h-12 shadow-lg">
                   <Link href="/">
                        <span className="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-100 hover:text-blue-500 cursor-pointer">Home</span>
                    </Link>
                    ...
                    <Link href="/alerts/PredictionsPage">
                        <span className="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-100 hover:text-blue-500 cursor-pointer">Predictions</span>
                    </Link>
                </div>
                <div>
                    {children}
